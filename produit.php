            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="libelle" placeholder="Nom du Produit" id="inputDefault" required>
                  <label class="col-form-label mt-4" for="inputDefault">Code</label>
                  <input type="text" class="form-control" name="code" placeholder="Code du produit" id="inputDefault" required>

                  <div class="form-group">
                    <label class="form-label mt-4" for="inputDefault">Prix</label>
                    <input type="number" min='0' class="form-control" name="prix" placeholder="saisir prix du produit" id="inputDefault" required>
        ...
        <tbody>
          ...
          ?>
              ...
              <tr>
                ...
                <a href="traitements /produits/delete.php?id=<?= $item['ID']; ?>" class="btn btn-danger">Delete</a>
              </td>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <div class="form-group">
                          <label class="col-form-label mt-4" for="inputDefault">Libelle</label>
                          <input type="text" class="form-control" value="<?= $item['libelle']; ?>" name="libelle" placeholder="Nom du Produit" id="inputDefault" required>
                          <label class="col-form-label mt-4" for="inputDefault">Code</label>
                          <input type="text" class="form-control" value="<?= $item['code']; ?>" name="code" placeholder="Code du produit" id="inputDefault" required>

                          <div class="form-group">
                            <label class="form-label mt-4">Prix</label>
                            <input type="number" min='0' class="form-control" value="<?= $item['prix']; ?>" name="prix" placeholder="saisir prix du produit" id="inputDefault" required>
